...
if __name__ == "__main__":
    ...
    output_dir = os.path.join("./recorded_data/dataset_test_3/aggregated_3d_masks.pth")
    ## 7 Visualize final refined masks
    check_refinedviz = True
    refined_path = os.path.join("./recorded_data/dataset_test_3/filtered_3d_masks.pth")
    ...
    point, color = read_pointcloud(os.path.join("./recorded_data/dataset_test_3/downsampled_pcd.ply"))
    color = color * 127.5
    print(len(color))
